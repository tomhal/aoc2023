pub const EXAMPLE_DATA: &str = "467..114..
...*......
..35..633.
......#...
617*......
...
pub fn read_input(input: &str) -> EngineSchematic {
    EngineSchematic::from_str(input)
}
...
mod tests {
    ...
    #[test]
    fn test_read_input() {
        let schematics = read_input(EXAMPLE_DATA);
        assert_eq!(10, schematics.serials.len());
    }
}
